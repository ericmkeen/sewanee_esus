...
library(readr) # install this package first, if you need to
...
#     OPTION A:
#     #Make a beautiful leaflet map of your proposed/realized study site,
#     including markers of proposed/realized sample locations.
#
#     OPTION B:
#     Make a beautiful leaflet map of your favorite restaurant in the world,
